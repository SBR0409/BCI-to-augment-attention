...
text = visual.TextStim(win=win, name='text',
    text='Observe the motion of the dots carefully. Once you think that they are moving in a specific direction, press the left or right arrow key as fast as possible.\n\nPress any key to start the experiment.',
    font='Open Sans',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('loopTemplate2.csv'),
